            ...
            <div class="col-xl-5 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h2 class="h5 text-gray-700 mb-2">Di E-Pengaduan Masyarakat</h2>
																				<h2 class="h5 text-gray-700 mb-4">Silahkan Daftar!</h2>
                                    </div>
                    ...
                    <!-- Form Login -->
                                    ...
                                    <div class="text-center">
                                        Sudah Punya Akun? <br>
                                        <a class="small mb-4" href="login.php">Masuk!</a>
                                    </div>
                                    <br>
                                    <div class="text-center">
                                        <a class="small mt-4" href="register.html">Masuk Sebagai Petugas</a>
                                    </div>
                                </div>
                            </div>
                        </div>
